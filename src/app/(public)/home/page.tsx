...
import { RecentlyUpdated } from "./components/recently-updated/recently-updated";
import {
  IMAGES,
  ANNOUCEMENTS,
  FANFICS_TAGS,
  ...
  CARDS_LINK,
  ORIGINALS_TAGS,
} from "@/lib/utils/mockup-arrays";
import { getHighlightsAndAthors } from "@/lib/api/highlights";

export default async function HomePage() {
  const { data, message, statusCode, timestamp } =
    await getHighlightsAndAthors();
